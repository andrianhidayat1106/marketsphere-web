 ...
 * formatCurrency dipindah ke utils/formatCurrency.js supaya tidak duplikat.
 */
const CartPage = () => {
      ...
      <div className="grid grid-cols-12 gap-8 items-start">
        ...
        <aside className="col-span-4 sticky top-28 space-y-6">
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
            ...
            <Link
              to={selectedItems.length > 0 ? "/payment" : "#"}
              onClick={(e) => {
                if (selectedItems.length === 0) e.preventDefault();
              }}
              className={`w-full flex items-center justify-center gap-3 font-bold py-4 rounded-2xl transition-all ${
                selectedItems.length > 0
                  ? "bg-[#00aa5b] hover:bg-[#008f4d] active:scale-[0.98] text-white shadow-lg shadow-[#00aa5b]/20"
