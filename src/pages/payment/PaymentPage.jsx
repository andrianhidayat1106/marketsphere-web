    ...
    <main className="max-w-7xl mx-auto px-4 lg:px-8 py-10 pb-20">
      <div className="mb-10">
        ...
        <p className="text-slate-500 font-medium">
          Selesaikan pesanan Anda dengan memilih metode pembayaran di bawah ini.
        </p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-8 items-start">
              ...
              {paymentMethods.map((method) => (
                <div key={method.id} className="space-y-4">
                  ...
                  {selectedMethod === method.id && method.options && (
                    <div className="ml-10 p-6 bg-slate-50 rounded-2xl border border-slate-100">
        ...
        <aside className="col-span-4 sticky top-28 space-y-6">
          <section className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            ...
            <Link
              to="/payment/success"
              className="w-full bg-[#00aa5b] hover:bg-[#008f4d] active:scale-[0.98] text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-lg shadow-[#00aa5b]/20 mb-6"
            >
              <Lock size={18} />
              Bayar Sekarang
            </Link>
